...
public interface ILjxxglMapper {
	...
	@Results(value = { @Result(id = true, property = "ljid", column = "ljid"), @Result(property = "useTag", column = "useTag"), @Result(property = "ljname", column = "ljname"),
			@Result(property = "cctype", column = "cctype"), @Result(property = "sjlj", column = "sjlj"), @Result(property = "gjsl", column = "gjsl"),
			@Result(property = "creDate", column = "creDate"), @Result(property = "inputman", column = "inputman"), @Result(property = "ljbm", column = "ljbm") })
	...
	@Results(value = { @Result(id = true, property = "ljid", column = "ljid"), @Result(property = "useTag", column = "useTag"), @Result(property = "ljname", column = "ljname"),
			@Result(property = "cctype", column = "cctype"), @Result(property = "sjlj", column = "sjlj"), @Result(property = "gjsl", column = "gjsl"),
			@Result(property = "creDate", column = "creDate"), @Result(property = "inputman", column = "inputman"), @Result(property = "ljbm", column = "ljbm"),
			@Result(property = "fk_khId", column = "fk_khId") })
