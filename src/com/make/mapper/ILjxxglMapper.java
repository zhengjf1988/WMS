...
public interface ILjxxglMapper {
	//零件信息管理接口
		//新增零件信息管理
	 @Insert("INSERT into t_ljxxgl (ljbm,ljname,fk_khid,cctype,sjlj,gjsl,creDate,inputman) values (#{ljbm},#{ljname},#{fk_khid},#{cctype},#{sjlj},#{gjsl},#{creDate},#{inputman});")
	 int addLjxxglBean(LjxxglBean ljxxglBean);
	//查询全部零件信息
	 @Select(value="select * from t_ljxxgl")
	 @Results(value = {@Result(id = true, property = "ljid", column = "ljid"),@Result(property = "useTag", column = "useTag"),@Result(property = "ljname", column = "ljname"),@Result(property = "fk_khid", column = "fk_khid"),@Result(property = "cctype", column = "cctype"),@Result(property = "sjlj", column = "sjlj"),@Result(property = "gjsl", column = "gjsl"),@Result(property = "creDate", column = "creDate"),@Result(property = "inputman", column = "inputman"),@Result(property = "ljbm", column = "ljbm")})
	 ...
	 //修改零件信息管理
	 @Update("update t_ljxxgl set ljname=#{ljname},fk_khid=#{fk_khid},cctype=#{cctype},sjlj=#{sjlj},gjsl=#{gjsl} ,ljbm=#{ljbm} where ljid=#{ljid}")
