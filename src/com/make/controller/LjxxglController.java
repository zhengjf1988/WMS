...
public class LjxxglController {
	//零件信息管理
		...
		public String add(String ljid,String ljbm,String ljname,String fk_khid,String cctype, String sjlj,String gjsl,HttpServletRequest req,HttpSession session) {
