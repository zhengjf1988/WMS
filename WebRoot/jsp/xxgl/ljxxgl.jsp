		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="form-group">
					...
					<div class="form-group">
						<label for="inputTitle" class="col-sm-2 control-label"> 客户名称
						</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="fk_khid"
								name="fk_khid">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
								<input type="texta" class="form-control" id="sjlj"
									name="sjlj"> 
	...
	function openupdate(){
		$(document).on("click","#table tr:gt(0)",function(){
			  var rows = $(this).parent().find("tr");
				...
				$("#fk_khid").val($(this).find("td:eq(3)").text());
				$("#cctype").val($(this).find("td:eq(4)").text());
				$("#sjlj").val($(this).find("td:eq(5)").text());
				$("#gjsl").val($(this).find("td:eq(6)").text());
