		...
		<div class="col-md-10">
			...
			<form action="" class="form-horizontal" role="form">
				<div class="row">
					...
					<div class="col-lg-2">
						<button type="button" class="btn btn-primary" data-toggle="modal" onclick="linkPage(0)">添加零件类型</button>
					</div>
...
<form action="part/save.do" class="form-horizontal" role="form" method="post" id="saveForm">
